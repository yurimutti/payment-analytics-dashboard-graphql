...
export type ChargeQuery = { charge: { id: string, amount: number | null, currency: string, status: Types.ChargeStatus, createdAt: unknown, updatedAt: unknown, orderId: string | null, sequenceId: string | null, descriptor: string | null, description: string | null, livemode: boolean | null, statusCode: string | null, statusMessage: string | null, customer: { name: string | null, email: string | null, phone: string | null } | null, paymentMethod: { method: Types.PaymentMethods | null, card: { brand: Types.CardBrand | null, last4: string | null, expiration: unknown } | null } | null, metadata: Array<{ key: string, value: string | null }> | null } | null };
