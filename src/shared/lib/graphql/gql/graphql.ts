...
export type ChargeQuery = { charge: (
    { sequenceId: string | null, descriptor: string | null, description: string | null, statusCode: string | null, statusMessage: string | null, metadata: Array<{ key: string, value: string | null }> | null }
